 ...
 * @author sepyke.eth
 * @notice Mock contract to test upgradeability of WstETHBridgeL2 smart
 * contract
 */
...
contract WstETHBridgeL2Test is Test {
  ...
  function _deployWstETHWrapped() internal returns (WstETHWrapped token) {
    ...
    WstETHWrapped wrappedTokenImplementation = new WstETHWrapped();
    ...
    bytes memory creationCode = abi.encodePacked(
      ...
      abi.encode(address(wrappedTokenImplementation), data)
    );
